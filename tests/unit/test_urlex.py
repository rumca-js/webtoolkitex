...
from webtoolkit.tests import (
    FakeInternetTestCase,
    YtdlpCrawlerMock,
    MockRequestCounter,
    MockCrawler,
    MockUrl,
...
class UrlExMock(UrlEx):
    ...
    def get_request_for_url(self, url):
        ...
        """
        request = super().get_request_for_url(url)
        if request.crawler_name == "YtdlpCrawler":
            request.crawler_name = "YtdlpCrawlerMock"
            request.crawler_type = YtdlpCrawlerMock(request.url)
        else:
    ...
    def get_init_request(self):
        ...
        """
        request = super().get_init_request()
        if request.crawler_name == "YtdlpCrawler":
            request.crawler_name = "YtdlpCrawlerMock"
            request.crawler_type = YtdlpCrawlerMock(request.url)
        else:
    ...
    def get_request_for_request(self, request):
        ...
        request = super().get_request_for_request(request)
        return request


class UrlExTest(FakeInternetTestCase):
    def setUp(self):
    ...
    def test_get_cleaned_link(self):
        ...
        url = UrlExMock(request=self.get_request(test_link))
    ...
    def test_get_handler__rss_page(self):
        ...
        # call tested function
        url = UrlExMock("https://www.codeproject.com/WebServices/NewsRSS.aspx")
    ...
    def test_get_type__html_page(self):
        ...
        handler = UrlExMock(test_link).get_type()
